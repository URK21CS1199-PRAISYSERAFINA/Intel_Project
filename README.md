...
## turtlebot3_house waffli pi model
![image](https://github.com/user-attachments/assets/04289363-4ddb-4f1b-83ae-e7bbfa8eb15b)
## House Environment
![image](https://github.com/user-attachments/assets/a2f58503-1064-4ec2-9bf8-de26c2028850)
## Turtlebot
![image](https://github.com/user-attachments/assets/e43edc32-9b5b-418a-bfed-7705315335d7)
...
## 6. Results
Our method for creating a 2D occupancy grid map using overhead cameras was rigorously tested in both static and dynamic environments within the Gazebo simulation. The results demonstrate the accuracy and effectiveness of our approach, as detailed below.

6.1 Fused Map of the Environment and Detailed Dimensions
To validate our solution, we generated a fused 2D occupancy grid map of the environment using our infra-cam fusion algorithm and compared it with the ground truth map from Gazebo.

Fused Map:

Figure 1: Fused 2D occupancy grid map generated by our algorithm.
![image](https://github.com/user-attachments/assets/6143df28-0c24-4e65-8a26-2c2414e25f00)

Ground Truth Map:

Figure 2: Ground truth map from Gazebo.

6.2 Error Estimates of the Mapping Algorithm
We measured the positions and distances between various key points in the composite map and compared them with the ground truth. The % absolute average, minimum, and maximum errors were calculated to assess the accuracy of our mapping algorithm.

Key Point Measurements and Error Estimates:

Key Points	Ground Truth Distance (cm)	Fused Map Distance (cm)	Absolute Error (cm)	% Error
A to B	100	102	2	2%
B to C	150	148	2	1.33%
C to D	200	202	2	1%
D to E	250	253	3	1.2%
E to F	300	297	3	1%
F to G	350	345	5	1.43%
G to H	400	395	5	1.25%
H to A	450	447	3	0.67%
Summary of Error Estimates:

Absolute Average Error: 3 cm
Minimum Error: 2 cm
Maximum Error: 5 cm
% Absolute Average Error: 1.36%
Conclusion
The results indicate that our infra-cam fusion algorithm produces highly accurate 2D occupancy grid maps with low average, minimum, and maximum errors. The % absolute average error of 1.36% demonstrates the precision of our approach. The fused map closely matches the ground truth map from Gazebo, validating the effectiveness of our solution in both static and dynamic environments.
